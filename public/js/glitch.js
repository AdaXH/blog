			...
			glitch: function() {
				...
				function getRandomInt(min, max) {
                                ...
                                if(this.settings.destroy === true) {
                	                ...
                	                // clone this.element insert before add class 'back' to static element
                                        ...
                                        if (this.settings.blend === true) { 
                                                ...
                                                // clone element insert front add class e'l-front-3'
                                                var cloneEl = $(el).clone();
                                                cloneEl.insertAfter(el).addClass('front-3').
